...
const amenities = [
  ...
  },
  {
    ...
    icon: (
      <AmenitySVG className="amenity-icon text-gold">
        <circle className="draw-path" cx="50" cy="50" r="35" strokeOpacity="0.3" />
        <path
          className="draw-path inner-ring"
          d="M30 50 L70 50 M50 30 L50 70"
        />
  ...
  },
  {
    ...
    icon: (
      <AmenitySVG className="amenity-icon text-gold">
        <path className="draw-path" d="M15 50 L50 15 L85 50 L85 85 L15 85 Z" />
        <circle className="social-pulse" cx="50" cy="55" r="8" fill="currentColor" />
      </AmenitySVG>
    ),
    animate: (el) => {
      gsap.to(el.querySelector(".social-pulse"), {
  ...
  },
  {
    ...
    icon: (
      <AmenitySVG className="amenity-icon text-gold">
        <path className="draw-path" d="M25 90 L25 15 L65 15" />
        <path className="lamp-head" d="M55 15 L75 30 L55 45 Z" fill="currentColor" />
        <path
          className="light-rays"
          d="M65 40 L65 70 M55 35 L40 50 M75 35 L90 50"
          strokeOpacity="0.5"
  ...
  },
  {
    ...
    icon: (
      <AmenitySVG className="amenity-icon text-gold">
        <circle className="draw-path" cx="50" cy="35" r="20" strokeOpacity="0.4" />
        <circle className="draw-path" cx="35" cy="65" r="20" strokeOpacity="0.4" />
        <circle className="draw-path" cx="65" cy="65" r="20" strokeOpacity="0.4" />
      </AmenitySVG>
    ),
    animate: (el) => {
      gsap.to(el.querySelectorAll("circle"), {
  ...
  },
  {
    ...
    icon: (
      <AmenitySVG className="amenity-icon text-gold">
        <rect className="cam-body draw-path" x="15" y="30" width="50" height="30" rx="2" />
        <circle className="lens" cx="40" cy="45" r="8" fill="currentColor" />
        <path className="cam-mount draw-path" d="M65 45 L85 30 L85 60 Z" />
      </AmenitySVG>
    ),
  ...
  },
  {
    ...
    icon: (
      <AmenitySVG className="amenity-icon text-gold">
        <path className="draw-path" d="M20 85 L35 20 L50 85 M50 85 L65 20 L80 85" />
        <rect className="swing-seat" x="42" y="55" width="16" height="6" rx="2" fill="currentColor" />
        <path className="draw-path" d="M45 20 L45 55 M55 20 L55 55" />
      </AmenitySVG>
    ),
    animate: (el) => {
